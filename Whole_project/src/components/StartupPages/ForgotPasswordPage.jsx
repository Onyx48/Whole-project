...
import { Link } from 'react-router-dom'; // For the "Back to log in" link
...
function ForgotPasswordPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validationError) {
      // Later, you'll handle form submission here (e.g., API call to send reset link)
      console.log('Forgot password for:', email);
      alert(`Password reset instructions would be sent to ${email} (Simulated)`);
      // setEmail(''); // Optionally clear the field after submission
    }
  };
    ...
    <div className="min-h-screen flex items-stretch text-white">
      ...
      <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-black">
        ...
        <div className="w-full py-6 z-20">
          <h1 className="text-4xl font-bold text-custom-orange mb-2">Forgot Password</h1>
          <p className="text-base text-gray-300 mb-8">
            Provide your account's email for which you <br /> want to reset your password
          </p>
          ...
          <form onSubmit={handleSubmit} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            <div className="pb-2 pt-4">
              ...
              {emailError && (
                <p className="mt-2 text-sm text-red-500 text-left" id="email-error">
                  {emailError}
                </p>
              )}
            </div>
            ...
            <div className="mt-8 text-center text-sm text-gray-400">
              <Link to="/login" className="font-semibold text-gray-300 hover:text-custom-orange hover:underline inline-flex items-center">
